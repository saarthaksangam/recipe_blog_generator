...
from backend.services.llm.llm_calls import call_openai_chat
from backend.services.prompt_builders.recipe_prompt import build_recipe_prompt_messages
from backend.services.youtube_utils.cleaner import strip_vtt_metadata
from backend.services.youtube_utils.thumbnail import get_thumbnail_from_youtube
from backend.services.youtube_utils.title import get_youtube_title
from backend.services.youtube_utils.transcript import get_srt_from_youtube
from backend.services.youtube_utils.upload_date import get_youtube_upload_date
...
def generate_blog_from_youtube(url: str) -> str:
    ...
    output_filename = f"{safe_filename} - {upload_date}.md"
